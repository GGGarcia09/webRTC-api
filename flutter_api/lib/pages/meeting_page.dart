...
import 'package:flutter_api/widgets/control_panel.dart';
import 'package:flutter_api/widgets/remote_connection.dart';
...
class MeetingPage extends StatefulWidget {
  ...
  const MeetingPage(
      {Key? key, this.meetingId, this.name, required this.meetingDetail}): super(key: key);
      ...
      children: [
        ...
        GridView.count(
          ...
          child: Padding(
            ...
            child: Text("Waiting for participants to join the meeting", textAlign: TextAlign.center, style: TextStyle(color: Colors.green, fontSize: 24),),
          ),
        ),
